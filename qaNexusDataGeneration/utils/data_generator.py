...
class DataGenerator:
    ...
    def generate_date(self, format=Constants.DEFAULT_DATE_FORMAT):
        """
        ...
        if "dd" in format_string:
            if year != -1 and month.isdigit():
                max_days = self.get_max_days(int(month), year)
            else:
                max_days = 31
    ...
    def generate_uuid(self, type=Constants.DEFAULT_UUID_TYPE):
        """
    ...
    def calculate_luhn_checksum(self, number):
        """
    ...
    def generate_credit_card_number(self):
        ...
        checksum = self.calculate_luhn_checksum(cc_number)
    ...
    def generate_binary_data(self, length):
        """
    ...
    def generate_unix_timestamp(self):
        """
    ...
    def generate_double(self, min_val, max_val):
        """
    ...
    def generate_long(self, min_val, max_val):
        """
    ...
    def generate_byte_array(self, length):
        """
    ...
    def generate_short(self, min_val, max_val):
        """
    ...
    def generate_char(self, min_val, max_val):
        """
    ...
    def generate_gaussian(self, mean: float, standard_deviation: float) -> float:
        """
    ...
    def generate_random_with_custom_distribution(self, probabilities: List[float]) -> int:
        """
    ...
    def generate_random_prime(self, min_val: int, max_val: int) -> int:
        """
        ...
        num = random.randint(self, min_val, max_val)
        while not is_prime(num):
            num = random.randint(min_val, max_val)
        return num

    def generate_random_percentage(self) -> float:
        """
    ...
    def generate_random_from_set(self, s: List[int]) -> int:
        """
    ...
    def generate_random_even(self, min_val: int, max_val: int) -> int:
        """
    ...
    def generate_random_odd(self, min_val: int, max_val: int) -> int:
        """
    ...
    def generate_unique_random_sequence(self, min_val: int, max_val: int, length: int) -> List[int]:
        """
    ...
    def generate_random_exponential(self, lambda_val: float) -> float:
        """
    ...
    def generate_random_complex_number(self, real_min: float, real_max: float, imaginary_min: float, imaginary_max: float) -> ComplexNumber:
        """
