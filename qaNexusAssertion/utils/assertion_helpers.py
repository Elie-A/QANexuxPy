...
class AssertionHelpers:
    ...
    def assert_is_number(self, obj, message):
        """
    ...
    def assert_is_not_number(self, obj, message):
        """
    ...
    def assert_equals(self, expected, actual, message):
        """
    ...
    def assert_not_equals(self, expected, actual, message):
        """
    ...
    def assert_deep_equals(self, expected, actual, message):
        """
    ...
    def assert_not_deep_equals(self, expected, actual, message):
        """
    ...
    def assert_is_true(self, condition, message):
        """
    ...
    def assert_is_false(self, condition, message):
        """
    ...
    def assert_throws(self, runnable, message):
        """
    ...
    def assert_is_type_of(self, expected_type, obj, message):
        """
    ...
    def assert_in_range(self, value, min_value, max_value, message):
        """
    ...
    def assert_not_in_range(self, value, min_value, max_value, message):
        """
    ...
    def assert_in_range_included(self, value, min_value, max_value, message):
        """
    ...
    def assert_not_in_range_included(self, value, min_value, max_value, message):
        """
    ...
    def assert_collection_contains(self, collection, element, message):
        """
    ...
    def assert_subset_of(self, subset, superset, message):
        """
    ...
    def assert_disjoint(self, collection1, collection2, message):
        """
    ...
    def assert_is_null_or_undefined(self, obj, message):
        """
    ...
    def assert_is_null(self, obj, message):
        """
    ...
    def assert_is_not_null_or_undefined(self, obj, message):
        """
    ...
    def assert_object_has_property(self, obj, property_name, message):
        """
    ...
    def assert_has_property_value(self, obj, field_name, expected_value, message):
        """
    ...
    def assert_empty_object(self, obj: Union[dict, Collection, str, None], message: str):
        """
    ...
    def assert_greater_than(self, value: float, reference: float, message: str):
        """
    ...
    def assert_greater_than_or_equal(self, value: float, reference: float, message: str):
        """
    ...
    def assert_less_than(self, value: float, reference: float, message: str):
        """
    ...
    def assert_less_than_or_equal(self, value: float, reference: float, message: str):
        """
    ...
    def assert_object_has_keys(self, obj: Dict[Any, Any], keys: Collection[Any], message: str):
        """
    ...
    def assert_is_collection_empty(self, collection: Collection[Any], message: str):
        """
    ...
    def assert_collection_is_not_empty(self, collection: Collection[Any], message: str):
        """
    ...
    def assert_collection_length(self, collection: Collection[Any], expected_length: int, message: str):
        """
    ...
    def assert_string_length(self, string: str, expected_length: int, message: str):
        """
    ...
    def assert_string_contains(self, string: str, substring: str, message: str):
        """
    ...
    def assert_string_starts_with(self, string: str, prefix: str, message: str):
        """
    ...
    def assert_string_ends_with(self, string: str, suffix: str, message: str):
        """
    ...
    def assert_string_matches_regex(self, string: str, regex: str, message: str):
        """
    ...
    def assert_string_not_matches_regex(self, string: str, regex: str, message: str):
        """
    ...
    def assert_instance_of(self, expected_class: Type[Any], obj: Any, message: str):
        """
    ...
    def assert_date(self, obj: object, message: str):
        """
    ...
    def assert_date_format(self, date: str, format: str, message: str):
        """
    ...
    def assert_is_function(self, obj: object, message: str):
        """
    ...
    def assert_not_deep_include(self, collection: Collection, element: object, message: str):
        """
    ...
    def assert_nested_include(self, collection: Collection, nested_element: object, message: str):
        """
    ...
    def assert_not_nested_include(self, collection: Collection, nested_element: object, message: str):
        """
    ...
    def assert_close_to(self, actual: float, expected: float, delta: float, message: str):
        """
    ...
    def assert_collections_same_members(self, collection1: Collection, collection2: Collection, message: str):
        """
    ...
    def assert_collection_not_same_members(self, collection1: Collection, collection2: Collection, message: str):
        """
    ...
    def assert_is_increment_of(self, value: int, reference: int, message: str):
        """
    ...
    def assert_not_increment_of(self, value: int, reference: int, message: str):
        """
    ...
    def assert_is_decrement_of(self, value: int, reference: int, message: str):
        """
    ...
    def assert_not_decrement_of(self, value: int, reference: int, message: str):
        """
    ...
    def assert_zero(self, value: float, message: str):
        """
    ...
    def assert_not_zero(self, value: float, message: str):
        """
    ...
    def assert_positive(self, value: float, message: str):
        """
    ...
    def assert_negative(self, value: float, message: str):
        """
    ...
    def assert_odd(self, value: int, message: str):
        """
    ...
    def assert_even(self, value: int, message: str):
        """
    ...
    def assert_valid_url(self, url: str, message: str):
        """
    ...
    def assert_valid_email(self, email: str, message: str):
        """
    ...
    def assert_is_array(self, obj: object, message: str):
        """
    ...
    def assert_is_not_array(self, obj: object, message: str):
        """
    ...
    def assert_array_length(self, array: List, expected_length: int, message: str):
        """
    ...
    def assert_object_is_empty(self, obj: object, message: str):
        """
    ...
    def assert_object_is_not_empty(self, obj: object, message: str):
        """
    ...
    def assert_object_includes(self, obj: Dict, value: object, message: str):
        """
    ...
    def assert_string_is_empty(self, s: str, message: str):
        """
    ...
    def assert_string_is_not_empty(self, s: str, message: str):
        """
    ...
    def assert_string_matches_pattern(self, s: str, pattern: str, message: str):
        """
    ...
    def assert_function_throws(self, func: Callable, expected_exception: Type[Exception], message: str):
        """
    ...
    def assert_function_does_not_throw(self, func: Callable, message: str):
        """
    ...
    def assert_function_returns(self, expected_value: T, func: Callable[[], T], message: str):
        """
